...
class Tuner:
    def __init__(self, train_set, test_set, base_conf):
        ...
        self.grid = {
            ...
            'NCL.n_layers': [1, 2, 3, 4],
            'NCL.tau': [0.1, 0.2, 0.3],
            'NCL.ssl_reg': [0.05, 0.1, 0.5],
            'NCL.proto_reg': [1e-5, 1e-4, 1e-3],
            'NCL.alpha': [0.3, 0.5, 0.7],
            'NCL.num_clusters': [50, 100, 200],
    ...
    def run(self):
        ...
        with open('ncl_tuning_individual.json', 'w') as f:
